...
from .guava_base import GuavaBase 
...
class DataUIModel(GuavaBase):
	...
	#####################################################################################
	def _data_process_add(self, db_fields:dict, data_class_ref:GuavaBase ):
	...
	#####################################################################################
	def _data_process_edit(self, db_fields:dict, data_class_ref:GuavaBase ):
	...
	#####################################################################################
	def _data_process_del(self, db_fields:dict, data_class_ref:GuavaBase ):
